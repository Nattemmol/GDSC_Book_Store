...
class BookInfo extends StatelessWidget {
  ...
  List<BookData> booksRelated = [
    BookData('Resources/images/Nifas.jpg', 'Born a Crime by Trevor Noah', 7.5, 'Trevor Noah',
        '2h 10m'),
    BookData('Resources/images/soul.jpg', 'Cogheart', 5.6, 'Peter Bunzl', '3h 10m'),
    BookData(
        'Resources/images/LastHope.jpg', 'Tebegna Ewnetoch', 4.7, 'Bewketu Seyum', '5h 10m'),
  ];
